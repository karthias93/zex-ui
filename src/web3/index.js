...
import { ZEX_STORAGE_ABI } from "./contracts/ZEX_STORAGE";
...
//User balance is fetched. The wallet address is stored in local browser cache same as metamask.
...
//Creates wallet address (account) of the user
...
//calling standard contract to send matic to other wallet addresses.
...
//send matic with parameters to receiver wallet address.
